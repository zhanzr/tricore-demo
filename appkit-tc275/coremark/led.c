...
void initLEDs (void)
{
    ...
    IfxPort_setPinMode(LED1, IfxPort_Mode_outputOpenDrainGeneral);
    IfxPort_setPinMode(LED2, IfxPort_Mode_outputOpenDrainGeneral);
    IfxPort_setPinMode(LED3, IfxPort_Mode_outputOpenDrainGeneral);
    IfxPort_setPinMode(LED4, IfxPort_Mode_outputOpenDrainGeneral);
