...
const Ifx_Shell_Command g_shellCommands[] = {{COMMAND_INFO, COMMAND_INFO_HELP_TEXT, &g_shellInterface, &printShellInfo},
        {COMMAND_TOGGLE, COMMAND_TOGGLE_HELP_TEXT, &g_shellInterface, &toggleLEDsShell}, {COMMAND_HELP,
                COMMAND_HELP_HELP_TEXT, &g_shellInterface, &Ifx_Shell_showHelp},
...
void printInfo (IfxStdIf_DPipe *io)
{
    ...
    IfxStdIf_DPipe_print(io, "  - '0': toggles all the LEDs on the board                                   "ENDLINE);
    IfxStdIf_DPipe_print(io, "  - '1': toggles the LED1                                                     "ENDLINE);
    IfxStdIf_DPipe_print(io, "  - '2': toggles the LED2                                                     "ENDLINE);
    IfxStdIf_DPipe_print(io, "  - '3': toggles the LED3                                                     "ENDLINE);
    IfxStdIf_DPipe_print(io, "  - '4': toggles the LED4                                                     "ENDLINE);
...
boolean toggleLEDsShell (pchar args, void *data, IfxStdIf_DPipe *io)
{
    switch (args[0])
    {
        case '0' : /* Turn on all LEDs */
            ...
            IfxStdIf_DPipe_print(io, "Toggled all LEDs!" ENDLINE ENDLINE);
            break;
        case '1' : /* Toggle LED1 */
            IfxPort_setPinState(LED1, IfxPort_State_toggled);
...
void initSerialInterface (void)
{
    ...
    .ctsMode = IfxPort_InputMode_pullUp, .rx = &IfxAsclin0_RXA_P14_1_IN, /* Select the pin for RX connected to the USB port      */
    .rxMode = IfxPort_InputMode_pullUp, /* RX pin                                               */
    .rts = NULL_PTR, /* RTS pin not used                                     */
    .rtsMode = IfxPort_OutputMode_pushPull, .tx = &IfxAsclin0_TX_P14_0_OUT, /* Select the pin for TX connected to the USB port      */
