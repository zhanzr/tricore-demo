...
#define	FLAGS_STR	"-O3 -ffast-math -funroll-loops"
#ifndef ITERATIONS
...
*/
            ...
            #define COMPILER_VERSION "TASKING " __VERSION__
        #else
            #define COMPILER_VERSION "TASKING"
        #endif
    #elif defined(__IS_COMPILER_ARM_COMPILER_6__) && __IS_COMPILER_ARM_COMPILER_6__
        #define COMPILER_VERSION __VERSION__
    #elif defined(__IS_COMPILER_ARM_COMPILER_5__) && __IS_COMPILER_ARM_COMPILER_5__
        #define COMPILER_VERSION "Arm Compiler 5"
    #elif defined(__IS_COMPILER_LLVM__) && __IS_COMPILER_LLVM__
        #define COMPILER_VERSION __VERSION__
    #elif defined(__IS_COMPILER_IAR__) && __IS_COMPILER_IAR__
